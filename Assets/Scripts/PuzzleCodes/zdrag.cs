...
public class zdrag : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (isDragging && !isColliding)
        {
            ...
            {
                Vector3 newPosition = new Vector3(transform.position.x, transform.position.y, hit.point.z + offset.z); // Y pozisyonunu sabit tut, sadece Z pozisyonunu deðiþtir
                if (rb != null)
                {
